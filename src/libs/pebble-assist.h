...
#define bitmap_layer_mark_dirty(layer) layer_mark_dirty(bitmap_layer_get_layer(layer))
...
#define inverter_layer_create_fullscreen(window) inverter_layer_create(layer_get_bounds(window_get_root_layer(window)))
...
// GBitmap Helpers
#define gbitmap_destroy_safe(bitmap) if (bitmap) { gbitmap_destroy(bitmap); }
